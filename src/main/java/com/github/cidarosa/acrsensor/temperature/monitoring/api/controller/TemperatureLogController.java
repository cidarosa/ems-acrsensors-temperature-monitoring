...
import com.github.cidarosa.acrsensor.temperature.monitoring.api.model.TemperatureLogOutputDTO;
import com.github.cidarosa.acrsensor.temperature.monitoring.domain.model.SensorId;
import com.github.cidarosa.acrsensor.temperature.monitoring.domain.model.TemperatureLog;
import com.github.cidarosa.acrsensor.temperature.monitoring.domain.repository.TemperatureLogRepository;
...
public class TemperatureLogController {
    ...
    @GetMapping
    public Page<TemperatureLogOutputDTO> search(@PathVariable TSID sensorId,
        ...
        return temperatureLogs.map(temperatureLog ->
                TemperatureLogOutputDTO.builder()
